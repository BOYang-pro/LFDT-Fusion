...
class Fusion_loss(nn.Module):
    ...
    def forward(self, image_A, image_B, image_fused):
        ...
        loss_l1       =20*self.L_Inten(image_A, image_B, image_fused) #20
        loss_gradient =20*self.L_Grad(image_A, image_B, image_fused)#20
        loss_SSIM     =10*(1 - self.L_SSIM(image_A, image_B, image_fused))#10
